...
let slct = document.querySelector('input')
let tux = document.querySelector(".bouton")
tux.addEventListener('click',rech);

function rech(){
   getLien("https://www.google.com/search?q=" + slct.value, slct.value)
}
